defmodule BreadpageWeb.UserLiveTest do
  use BreadpageWeb.ConnCase

  import Phoenix.LiveViewTest
  import Breadpage.AccountsFixtures

  @create_attrs %{username: "some username", email: "some email", posts: [1, 2]}
  @update_attrs %{username: "some updated username", email: "some updated email", posts: [1]}
  @invalid_attrs %{username: nil, email: nil, posts: []}
